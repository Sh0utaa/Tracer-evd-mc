...
///   TRACER Framework
///////////////////////////////////////////////////////   Creation History
///   Name:		modified_FlyControls.js
///   Description:    threejs biblioteka fly controlistvis
///   Functions:  
///   Author:	  THREEJS team                
///   Date: 10/03/2021
///////////////////////////////////////////////////////   Change History
...
///   Date:  19/06/21
///   Description: daemata komentarebi, 328,329 xazebze gaukmda klaviaturis msmeneli funkciebi
//////////////////////////////////////////////////////////////////////////////////
    ...
    this.dispose = function () {
        ...
        window.removeEventListener("pointerdown", _mousedown);
        window.removeEventListener("pointermove", _mousemove);
        window.removeEventListener("pointereup", _mouseup);

       	// gakomentarda klaviaturis msmeneli funkciebi
    ...
    window.addEventListener("pointermove", _mousemove);
    window.addEventListener("pointerdown", _mousedown);
